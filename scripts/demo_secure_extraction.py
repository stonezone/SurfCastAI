...
def demo_path_traversal():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            print(f"✓ SUCCESS: Path traversal detected and blocked")
            print(f"  Error: {e}")
...
def demo_file_too_large():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            print(f"✓ SUCCESS: Oversized file detected and blocked")
            print(f"  Error: {e}")
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            if ratio > MAX_COMPRESSION_RATIO:
                ...
                print(f"⚠ SKIP: Compression ratio ({ratio:.1f}x) not high enough to trigger detection")
        except SecurityError as e:
            print(f"✓ SUCCESS: Zip bomb detected and blocked")
            print(f"  Error: {e}")
...
def demo_total_size_exceeded():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            ...
            print(f"✓ SUCCESS: Total size limit enforced")
            print(f"  Error: {e}")
...
def demo_valid_extraction():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"Created valid archive with 3 files")
        ...
        try:
            ...
            # Verify extraction
            if (target_dir / "file1.txt").exists() and (target_dir / "subdir" / "file2.txt").exists():
                print(f"✓ SUCCESS: Valid archive extracted successfully")
