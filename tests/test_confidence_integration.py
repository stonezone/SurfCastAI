...
class TestConfidenceScorerIntegration:
    ...
    def sample_input_data(self):
        ...
        return {
            "metadata": {"forecast_id": "test_forecast_001", "bundle_id": "test_bundle"},
            "buoy_data": [
                {
                    "station_id": "51001",
                        ...
                        "swell_events": [
                            {
                                ...
                                "peak_time": datetime.now(UTC).isoformat(),
                                "peak_direction": 315,
                                "peak_height": 2.4,
                                "peak_period": 12,
                                "significance": 0.75,
    ...
    def test_confidence_with_minimal_data(self, fusion_system):
        ...
        minimal_data = {
            "metadata": {"forecast_id": "test_minimal", "bundle_id": "test_bundle"},
            "model_data": [
                {
                    "model_id": "ww3_global",
                    "region": "global",
    ...
    def test_confidence_warnings_generated(self, fusion_system, sample_input_data):
        ...
        assert any("limited data" in w.lower() or "missing" in w.lower() for w in result.warnings)
    ...
    def test_confidence_logged(self, fusion_system, sample_input_data, caplog):
        ...
        assert (
            str(round(confidence["overall_score"], 3)) in caplog.text
            or str(round(confidence["overall_score"], 2)) in caplog.text
        )
