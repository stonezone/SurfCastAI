...
class TestWeatherProcessor(unittest.TestCase):
    ...
    def test_get_surf_quality_factor(self):
        ...
        weather_data = WeatherData(
            ...
            metadata={
                'wind_analysis': {
                    'shore_impacts': {
                        'north_shore': {
                            'overall_rating': 0.8  # Good rating for north shore
                        },
                        'south_shore': {
                            'overall_rating': 0.2  # Poor rating for south shore
                        }
                    }
                },
                'surf_weather': {
        ...
        self.assertGreater(north_factor, south_factor, "North shore should have better factor than south")
