...
class TestConfigValidation:
    ...
    def test_invalid_model_name_warning(self, tmp_path):
        ...
        config_data = {
            ...
            'openai': {
                'default_model': 'gpt-9000'  # Invalid model
            }
        }
    ...
    def test_valid_model_names(self, tmp_path):
        ...
        for model in valid_models:
            ...
            assert len(model_warnings) == 0, f"Model {model} should be valid but got warnings: {model_warnings}"
    ...
    def test_invalid_rate_limit_error(self, tmp_path):
        ...
        config_data = {
            ...
            'rate_limits': {
                'example.com': {
                    'requests_per_second': -1.0  # Invalid: must be > 0
                }
            }
        }
    ...
    def test_zero_rate_limit_error(self, tmp_path):
        ...
        config_data = {
            ...
            'rate_limits': {
                'example.com': {
                    'requests_per_second': 0  # Invalid: must be > 0
                }
            }
        }
    ...
    def test_multiple_validation_errors(self, tmp_path):
        ...
        config_data = {
            ...
            'data_sources': {
                'test': {
                    'enabled': True,
                    'urls': ['not-a-url']  # Error: invalid URL
                }
            },
            'rate_limits': {
                'example.com': {
                    'requests_per_second': -1  # Error: invalid rate
                }
            }
        }
    ...
    def test_non_numeric_rate_limit_error(self, tmp_path):
        ...
        config_data = {
            ...
            'rate_limits': {
                'example.com': {
                    'requests_per_second': 'fast'  # Invalid: not numeric
                }
            }
        }
