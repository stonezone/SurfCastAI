...
class TestSeniorForecasterContradictions:
    ...
    def test_identify_contradictions_none_in_consistent_data(self, senior_forecaster, sample_buoy_analysis, sample_pressure_analysis):
    ...
    def test_identify_contradictions_buoy_signal_without_pressure_support(self, senior_forecaster):
        ...
        buoy_analysis = BuoyAnalystOutput(
            confidence=0.85,
            data=buoy_data,
            narrative="South swell building"
        )
    ...
    def test_identify_contradictions_predicted_swell_without_buoy_confirmation(self, senior_forecaster):
    ...
    def test_identify_contradictions_timing_mismatch(self, senior_forecaster):
        ...
        pressure_analysis = PressureAnalystOutput(
            confidence=0.80,
            data=pressure_data,
            narrative="NW swell arriving tomorrow"
        )
        ...
        timing_contradiction = next(
            (c for c in contradictions if 'decreasing trend' in c['issue']),
            None
        )
    ...
    def test_identify_contradictions_only_buoy_specialist(self, senior_forecaster, sample_buoy_analysis):
    ...
    def test_identify_contradictions_only_pressure_specialist(self, senior_forecaster, sample_pressure_analysis):
...
class TestSeniorForecasterAgreement:
    ...
    def test_calculate_specialist_agreement_perfect_match(self, senior_forecaster, sample_buoy_analysis, sample_pressure_analysis):
    ...
    def test_calculate_specialist_agreement_strong_disagreement(self, senior_forecaster):
        ...
        pressure_analysis = PressureAnalystOutput(
            confidence=0.90,
            data=pressure_data,
            narrative="Strong N swell predicted"
        )
    ...
    def test_calculate_specialist_agreement_missing_buoy(self, senior_forecaster, sample_pressure_analysis):
    ...
    def test_calculate_specialist_agreement_missing_pressure(self, senior_forecaster, sample_buoy_analysis):
...
class TestSeniorForecasterShoreForecasts:
    ...
    def test_generate_shore_forecasts_north_shore_winter(self, senior_forecaster, sample_buoy_analysis, sample_pressure_analysis):
    ...
    def test_generate_shore_forecasts_east_shore(self, senior_forecaster):
        ...
        buoy_analysis = BuoyAnalystOutput(
            confidence=0.85,
            data=buoy_data,
            narrative="E trade swell steady"
        )
    ...
    def test_generate_shore_forecasts_no_swell_data(self, senior_forecaster):
        ...
        for shore in ['north_shore', 'south_shore', 'east_shore', 'west_shore']:
            ...
            assert '1-' in shore_forecasts[shore]['size_range'] or '2-' in shore_forecasts[shore]['size_range']
    ...
    def test_generate_shore_forecasts_multiple_overlapping_swells(self, senior_forecaster):
        ...
        buoy_analysis = BuoyAnalystOutput(
            confidence=0.85,
            data=buoy_data,
            narrative="Multiple N sector swells"
        )
    ...
    def test_generate_shore_forecasts_size_range_formatting(self, senior_forecaster, sample_buoy_analysis):
    ...
    def test_generate_shore_forecasts_quality_descriptors(self, senior_forecaster):
        ...
        buoy_analysis = BuoyAnalystOutput(
            confidence=0.85,
            data=buoy_data,
            narrative="Long-period groundswell"
        )
        ...
        north = shore_forecasts['north_shore']
        assert 'conditions' in north
        assert north['conditions'] in ['clean', 'fair', 'choppy', 'mixed and choppy',
                                       'fair to choppy', 'small and clean']
...
class TestSeniorForecasterSwellBreakdown:
    ...
    def test_generate_swell_breakdown_single_dominant_swell(self, senior_forecaster, sample_buoy_analysis):
    ...
    def test_generate_swell_breakdown_primary_and_secondary_swells(self, senior_forecaster, sample_buoy_analysis, sample_pressure_analysis):
    ...
    def test_generate_swell_breakdown_direction_grouping(self, senior_forecaster):
        ...
        pressure_analysis = PressureAnalystOutput(
            confidence=0.80,
            data=pressure_data,
            narrative="NW sector swells"
        )

        # Act
        swell_breakdown = senior_forecaster._generate_swell_breakdown(
            None, pressure_analysis
        )
...
class TestSeniorForecasterInitialization:
    ...
    def test_initialization_success(self, mock_config, mock_engine):
        ...
        # Act
        forecaster = SeniorForecaster(config=mock_config, model_name='gpt-4o-mini', engine=mock_engine)
