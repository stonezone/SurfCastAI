...
from src.processing.models.swell_event import SwellEvent, SwellComponent, SwellForecast, ForecastLocation
...
def test_filter_excluded_components():
    ...
    event = SwellEvent(
        ...
        primary_components=[
            SwellComponent(height=2.0, period=14.0, direction=315.0, quality_flag='valid'),
            SwellComponent(height=1.5, period=15.0, direction=180.0, quality_flag='excluded')  # Should be filtered
        ]
    )
...
def test_exclude_event_with_no_valid_components():
    ...
    event = SwellEvent(
        ...
        primary_components=[
            SwellComponent(height=1.5, period=15.0, direction=180.0, quality_flag='excluded')  # But component is excluded
        ]
    )
