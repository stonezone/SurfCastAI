...
class TestConfidenceScorer:
    ...
    def sample_fusion_data(self):
        ...
        return {
            "swell_events": [
                Mock(source="model", primary_components=[Mock(height=2.5), Mock(height=2.3)]),
                Mock(source="model", primary_components=[Mock(height=2.4), Mock(height=2.6)]),
    ...
    def test_calculate_model_consensus_single_model(self, scorer):
        ...
        fusion_data = {
            "swell_events": [Mock(source="model", primary_components=[Mock(height=2.5)])],
            "metadata": {},
        }
    ...
    def test_calculate_model_consensus_no_models(self, scorer):
        ...
        fusion_data = {"swell_events": [], "metadata": {}}
    ...
    def test_calculate_data_completeness_all_sources(self, scorer):
        ...
        fusion_data = {
            "swell_events": [Mock(source="buoy"), Mock(source="model")],
            "metadata": {"charts": ["chart1.png"], "satellite": ["sat1.png"]},
        }
    ...
    def test_calculate_data_completeness_partial_sources(self, scorer):
        ...
        fusion_data = {"swell_events": [Mock(source="model")], "metadata": {}}
    ...
    def test_calculate_historical_accuracy_with_mae(self, scorer):
        ...
        fusion_data = {"metadata": {"validation": {"recent_mae": 2.0}}}  # 2 feet MAE
    ...
    def test_calculate_historical_accuracy_perfect(self, scorer):
        ...
        fusion_data = {"metadata": {"validation": {"recent_mae": 0.0}}}
    ...
    def test_calculate_historical_accuracy_poor(self, scorer):
        ...
        fusion_data = {"metadata": {"validation": {"recent_mae": 6.0}}}
    ...
    def test_calculate_confidence_complete(self, scorer, sample_fusion_data):
        ...
        result = scorer.calculate_confidence(sample_fusion_data, forecast_horizon_days=2)
    ...
    def test_calculate_confidence_category_correctness(self, scorer, sample_fusion_data):
        ...
        result = scorer.calculate_confidence(sample_fusion_data, forecast_horizon_days=3)
    ...
    def test_confidence_with_minimal_data(self, scorer):
        ...
        minimal_data = {"swell_events": [], "locations": [], "metadata": {}}
    ...
    def test_warnings_generated_for_low_confidence(self, scorer):
        ...
        poor_data = {"swell_events": [], "locations": [], "metadata": {}}
